		...
		{:else}
			...
			<div class="w-full overflow-x-auto scrollbar-hide">
				<ul class="flex items-center gap-4 lg:gap-6 xl:gap-8 min-w-max lg:justify-center xl:justify-between">
					...
					<!-- Link Lançamentos Exclusivos - Item especial destacado -->
					<li class="flex-shrink-0">
						<a 
							href="/lancamentos-exclusivos"
							class="flex items-center gap-2 py-3 px-2 text-yellow-300 hover:text-yellow-100 transition-all group relative whitespace-nowrap"
							onclick={handleLinkClick}
							style="font-family: 'Lato', sans-serif; font-weight: 700; font-size: clamp(13px, 1.2vw, 16px);"
						>
							<svg class="w-3 h-3 lg:w-4 lg:h-4 text-yellow-300 group-hover:text-yellow-100 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
							</svg>
							<span>Lançamentos Exclusivos</span>
							
							<!-- Indicador hover -->
							<span class="absolute bottom-0 left-0 right-0 h-0.5 bg-yellow-300 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></span>
						</a>
					</li>

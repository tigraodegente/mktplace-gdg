...
<header class="hidden lg:block bg-[#00BFB3] sticky top-0 z-[100] {className}">
	...
	<div class="w-full max-w-[1440px] mx-auto h-[140px] lg:h-[150px] xl:h-[150px] flex flex-col">
		<!-- Top Header com busca e ações -->
		<div class="flex-1 px-4 lg:px-6 xl:px-8 flex items-center">
			<div class="w-full flex items-center justify-between gap-2 lg:gap-3 xl:gap-4">
				<!-- Logo -->
				...
				<!-- Search Bar -->
				<SearchBox class="flex-1 min-w-0 max-w-[600px] lg:max-w-[800px] xl:max-w-[900px]" />
				
				<!-- User Actions -->
				<div class="flex items-center gap-2 lg:gap-3 xl:gap-4 flex-shrink-0">
					{#if $isAuthenticated}
					...
					{:else}
						<a href="/login" class="flex items-center gap-1 lg:gap-2 text-white hover:text-white/80 transition text-sm lg:text-base" aria-label="Fazer login">
							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="lg:w-5 lg:h-5" viewBox="0 0 23 23" fill="none" aria-hidden="true">
								<path fill-rule="evenodd" clip-rule="evenodd" d="M6.82023 6.89176C6.82023 4.32197 8.87064 2.26566 11.3671 2.26566C13.8635 2.26566 15.914 4.32197 15.914 6.89176C15.914 9.46154 13.8635 11.5179 11.3671 11.5179C8.87064 11.5179 6.82023 9.46154 6.82023 6.89176ZM11.3671 0C7.58987 0 4.55457 3.1004 4.55457 6.89176C4.55457 10.6832 7.58987 13.7835 11.3671 13.7835C15.1443 13.7835 18.1796 10.6832 18.1796 6.89176C18.1796 3.1004 15.1443 0 11.3671 0Z" fill="white"/>
								<path d="M2 21.0845C3.69198 17.7603 7.3223 15.462 11.5278 15.462C15.7332 15.462 19.3635 17.7603 21.0555 21.0845" stroke="white" stroke-width="2.38958" stroke-linecap="round"/>
							</svg>
					...
					<div class="flex items-center gap-2 lg:gap-3">
						<a href="/favoritos" class="flex items-center justify-center w-5 h-5 lg:w-6 lg:h-6 text-white hover:text-white/80 transition" aria-label="Favoritos">
						...
						>
							<button 
								...
								class="flex items-center justify-center w-5 h-5 lg:w-6 lg:h-6 text-white hover:text-white/80 transition" 
								aria-label="Carrinho de compras"

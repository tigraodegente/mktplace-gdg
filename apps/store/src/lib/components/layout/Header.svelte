			...
			<div class="w-full flex items-center justify-between gap-3">
				...
				<div class="flex items-center gap-3 flex-shrink-0">
					...
					<a href="/favoritos" class="relative text-white hover:text-white/80 transition" aria-label="Favoritos">
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 28 26" fill="none" aria-hidden="true">
					...
					>
						...
						>
							<svg xmlns="http://www.w3.org/2000/svg" width="18" height="24" viewBox="0 0 21 27" fill="none" aria-hidden="true">
							...
							{#if totalItems > 0}
								<span class="absolute -top-2 -right-2 bg-white text-[#00BFB3] text-xs rounded-full h-5 w-5 flex items-center justify-center font-medium animate-pulse">
									{totalItems}
								</span>
							{/if}
						</button>
						...
						<!-- Mini Cart -->
						<div onmouseenter={keepMiniCartVisible} onmouseleave={hideMiniCart}>
							<MiniCart 

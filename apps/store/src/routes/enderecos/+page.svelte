			...
			{#if showSuccessMessage}
				<div class="mb-6 bg-green-50 border border-green-200 rounded-lg p-4" transition:slide>
					<div class="flex">
						...
						<button class="ml-auto text-green-400 hover:text-green-600" on:click={() => showSuccessMessage = false} aria-label="Fechar mensagem de sucesso">
			...
			<div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
				...
				<div class="lg:col-span-1">
					<nav class="bg-white rounded-lg shadow-sm p-4 sticky top-8">
						...
						<ul class="space-y-2">
							<li>
								<a href="/conta" class="flex items-center gap-3 px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
							...
							<li>
								<a href="/pedidos" class="flex items-center gap-3 px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
									<svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							...
							<li>
								<a href="/favoritos" class="flex items-center gap-3 px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
									<svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							...
							<li>
								<a href="/configuracoes" class="flex items-center gap-3 px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
									<svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">

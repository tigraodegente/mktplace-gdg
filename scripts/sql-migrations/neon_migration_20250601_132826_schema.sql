...
ALTER TABLE IF EXISTS ONLY public.user_sessions_multi_role DROP CONSTRAINT IF EXISTS user_sessions_multi_role_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tracking_consents DROP CONSTRAINT IF EXISTS tracking_consents_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.support_tickets DROP CONSTRAINT IF EXISTS support_tickets_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.support_tickets DROP CONSTRAINT IF EXISTS support_tickets_order_id_fkey;
ALTER TABLE IF EXISTS ONLY public.support_tickets DROP CONSTRAINT IF EXISTS support_tickets_category_id_fkey;
ALTER TABLE IF EXISTS ONLY public.support_tickets DROP CONSTRAINT IF EXISTS support_tickets_assigned_to_fkey;
ALTER TABLE IF EXISTS ONLY public.support_messages DROP CONSTRAINT IF EXISTS support_messages_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.support_messages DROP CONSTRAINT IF EXISTS support_messages_ticket_id_fkey;
ALTER TABLE IF EXISTS ONLY public.support_categories DROP CONSTRAINT IF EXISTS support_categories_auto_assign_to_fkey;
ALTER TABLE IF EXISTS ONLY public.store_credits DROP CONSTRAINT IF EXISTS store_credits_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.store_credits DROP CONSTRAINT IF EXISTS store_credits_return_id_fkey;
ALTER TABLE IF EXISTS ONLY public.stock_reservation_items DROP CONSTRAINT IF EXISTS stock_reservation_items_reservation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.stock_reservation_items DROP CONSTRAINT IF EXISTS stock_reservation_items_product_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.shipping_zones DROP CONSTRAINT IF EXISTS shipping_zones_carrier_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shipping_rates DROP CONSTRAINT IF EXISTS shipping_rates_zone_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shipping_modality_configs DROP CONSTRAINT IF EXISTS shipping_modality_configs_zone_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shipping_modality_configs DROP CONSTRAINT IF EXISTS shipping_modality_configs_modality_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shipping_calculated_options DROP CONSTRAINT IF EXISTS shipping_calculated_options_zone_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shipping_calculated_options DROP CONSTRAINT IF EXISTS shipping_calculated_options_modality_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shipping_calculated_options DROP CONSTRAINT IF EXISTS shipping_calculated_options_base_rate_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shipping_base_rates DROP CONSTRAINT IF EXISTS shipping_base_rates_zone_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.seller_shipping_configs DROP CONSTRAINT IF EXISTS seller_shipping_configs_zone_id_fkey;
ALTER TABLE IF EXISTS ONLY public.seller_shipping_configs DROP CONSTRAINT IF EXISTS seller_shipping_configs_carrier_id_fkey;
ALTER TABLE IF EXISTS ONLY public.search_index DROP CONSTRAINT IF EXISTS search_index_product_id_fkey;
ALTER TABLE IF EXISTS ONLY public.search_history DROP CONSTRAINT IF EXISTS search_history_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.search_history DROP CONSTRAINT IF EXISTS search_history_clicked_product_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.returns DROP CONSTRAINT IF EXISTS returns_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.returns DROP CONSTRAINT IF EXISTS returns_reason_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.product_rankings DROP CONSTRAINT IF EXISTS product_rankings_product_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.payment_queue DROP CONSTRAINT IF EXISTS payment_queue_payment_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.order_tracking DROP CONSTRAINT IF EXISTS order_tracking_created_by_fkey;
...
ALTER TABLE IF EXISTS ONLY public.integration_retry_queue DROP CONSTRAINT IF EXISTS integration_retry_queue_provider_id_fkey;
ALTER TABLE IF EXISTS ONLY public.integration_provider_environments DROP CONSTRAINT IF EXISTS integration_provider_environments_provider_id_fkey;
ALTER TABLE IF EXISTS ONLY public.integration_provider_environments DROP CONSTRAINT IF EXISTS integration_provider_environments_environment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.integration_metrics DROP CONSTRAINT IF EXISTS integration_metrics_provider_id_fkey;
ALTER TABLE IF EXISTS ONLY public.integration_logs DROP CONSTRAINT IF EXISTS integration_logs_retry_queue_id_fkey;
ALTER TABLE IF EXISTS ONLY public.integration_logs DROP CONSTRAINT IF EXISTS integration_logs_provider_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_lists DROP CONSTRAINT IF EXISTS gift_lists_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_templates DROP CONSTRAINT IF EXISTS gift_list_templates_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_items DROP CONSTRAINT IF EXISTS gift_list_items_purchased_by_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_items DROP CONSTRAINT IF EXISTS gift_list_items_product_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_items DROP CONSTRAINT IF EXISTS gift_list_items_list_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_invites DROP CONSTRAINT IF EXISTS gift_list_invites_list_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_invites DROP CONSTRAINT IF EXISTS gift_list_invites_invited_by_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_favorites DROP CONSTRAINT IF EXISTS gift_list_favorites_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_favorites DROP CONSTRAINT IF EXISTS gift_list_favorites_list_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_comments DROP CONSTRAINT IF EXISTS gift_list_comments_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_comments DROP CONSTRAINT IF EXISTS gift_list_comments_parent_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_comments DROP CONSTRAINT IF EXISTS gift_list_comments_list_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_analytics DROP CONSTRAINT IF EXISTS gift_list_analytics_list_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_contributions DROP CONSTRAINT IF EXISTS gift_contributions_payment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_contributions DROP CONSTRAINT IF EXISTS gift_contributions_order_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_contributions DROP CONSTRAINT IF EXISTS gift_contributions_list_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_contributions DROP CONSTRAINT IF EXISTS gift_contributions_item_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gift_contributions DROP CONSTRAINT IF EXISTS gift_contributions_contributor_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gdpr_requests DROP CONSTRAINT IF EXISTS gdpr_requests_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.gdpr_requests DROP CONSTRAINT IF EXISTS gdpr_requests_processed_by_fkey;
...
ALTER TABLE IF EXISTS ONLY public.coupon_products DROP CONSTRAINT IF EXISTS coupon_products_product_id_fkey;
ALTER TABLE IF EXISTS ONLY public.coupon_products DROP CONSTRAINT IF EXISTS coupon_products_coupon_id_fkey;
ALTER TABLE IF EXISTS ONLY public.coupon_conditions DROP CONSTRAINT IF EXISTS coupon_conditions_coupon_id_fkey;
ALTER TABLE IF EXISTS ONLY public.coupon_categories DROP CONSTRAINT IF EXISTS coupon_categories_coupon_id_fkey;
ALTER TABLE IF EXISTS ONLY public.coupon_categories DROP CONSTRAINT IF EXISTS coupon_categories_category_id_fkey;
ALTER TABLE IF EXISTS ONLY public.consent_records DROP CONSTRAINT IF EXISTS consent_records_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.consent_records DROP CONSTRAINT IF EXISTS consent_records_processing_activity_id_fkey;
ALTER TABLE IF EXISTS ONLY public.consent_records DROP CONSTRAINT IF EXISTS consent_records_parent_consent_id_fkey;
ALTER TABLE IF EXISTS ONLY public.chat_settings DROP CONSTRAINT IF EXISTS chat_settings_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.chat_presence DROP CONSTRAINT IF EXISTS chat_presence_user_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.chat_message_reads DROP CONSTRAINT IF EXISTS chat_message_reads_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.chat_message_reads DROP CONSTRAINT IF EXISTS chat_message_reads_message_id_fkey;
ALTER TABLE IF EXISTS ONLY public.chat_conversations DROP CONSTRAINT IF EXISTS chat_conversations_seller_id_fkey;
ALTER TABLE IF EXISTS ONLY public.chat_conversations DROP CONSTRAINT IF EXISTS chat_conversations_order_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.campaign_recipients DROP CONSTRAINT IF EXISTS campaign_recipients_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_recipients DROP CONSTRAINT IF EXISTS campaign_recipients_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campaign_analytics DROP CONSTRAINT IF EXISTS campaign_analytics_campaign_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.ab_tests DROP CONSTRAINT IF EXISTS ab_tests_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.ab_test_variants DROP CONSTRAINT IF EXISTS ab_test_variants_test_id_fkey;
ALTER TABLE IF EXISTS ONLY public.ab_test_events DROP CONSTRAINT IF EXISTS ab_test_events_variant_id_fkey;
ALTER TABLE IF EXISTS ONLY public.ab_test_events DROP CONSTRAINT IF EXISTS ab_test_events_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.ab_test_events DROP CONSTRAINT IF EXISTS ab_test_events_test_id_fkey;
ALTER TABLE IF EXISTS ONLY public.ab_test_assignments DROP CONSTRAINT IF EXISTS ab_test_assignments_variant_id_fkey;
ALTER TABLE IF EXISTS ONLY public.ab_test_assignments DROP CONSTRAINT IF EXISTS ab_test_assignments_user_id_fkey;
...
DROP TRIGGER IF EXISTS update_integration_retry_queue_updated_at ON public.integration_retry_queue;
DROP TRIGGER IF EXISTS update_integration_providers_updated_at ON public.integration_providers;
DROP TRIGGER IF EXISTS update_integration_provider_environments_updated_at ON public.integration_provider_environments;
DROP TRIGGER IF EXISTS update_integration_environments_updated_at ON public.integration_environments;
DROP TRIGGER IF EXISTS trigger_update_gift_amounts ON public.gift_contributions;
DROP TRIGGER IF EXISTS trigger_generate_share_token ON public.gift_lists;
DROP INDEX IF EXISTS public.idx_webhook_events_status;
DROP INDEX IF EXISTS public.idx_webhook_events_priority;
DROP INDEX IF EXISTS public.idx_webhook_events_next_retry;
DROP INDEX IF EXISTS public.idx_webhook_events_event_type;
DROP INDEX IF EXISTS public.idx_webhook_events_created_at;
DROP INDEX IF EXISTS public.idx_users_vendor_data;
DROP INDEX IF EXISTS public.idx_users_roles;
DROP INDEX IF EXISTS public.idx_users_email;
DROP INDEX IF EXISTS public.idx_users_admin_data;
DROP INDEX IF EXISTS public.idx_user_sessions_multi_role_user_id;
DROP INDEX IF EXISTS public.idx_user_sessions_multi_role_token;
DROP INDEX IF EXISTS public.idx_user_sessions_multi_role_expires_at;
DROP INDEX IF EXISTS public.idx_tracking_consents_user_id;
DROP INDEX IF EXISTS public.idx_tracking_consents_session;
...
DROP INDEX IF EXISTS public.idx_support_messages_ticket_id;
DROP INDEX IF EXISTS public.idx_stock_reservations_status;
DROP INDEX IF EXISTS public.idx_stock_reservations_session;
DROP INDEX IF EXISTS public.idx_stock_reservations_expires;
...
DROP INDEX IF EXISTS public.idx_shipping_zones_uf;
DROP INDEX IF EXISTS public.idx_shipping_zones_postal;
DROP INDEX IF EXISTS public.idx_shipping_zones_carrier;
DROP INDEX IF EXISTS public.idx_shipping_quotes_expires;
DROP INDEX IF EXISTS public.idx_shipping_quotes_cache;
...
DROP INDEX IF EXISTS public.idx_sellers_location;
DROP INDEX IF EXISTS public.idx_search_vector_gin;
DROP INDEX IF EXISTS public.idx_search_tags_gin;
DROP INDEX IF EXISTS public.idx_search_suggestions_term;
DROP INDEX IF EXISTS public.idx_search_price_range;
DROP INDEX IF EXISTS public.idx_search_metaphone;
DROP INDEX IF EXISTS public.idx_search_history_user_id;
DROP INDEX IF EXISTS public.idx_search_history_session;
DROP INDEX IF EXISTS public.idx_search_history_query;
DROP INDEX IF EXISTS public.idx_search_history_created_at;
DROP INDEX IF EXISTS public.idx_reviews_user;
DROP INDEX IF EXISTS public.idx_reviews_product;
DROP INDEX IF EXISTS public.idx_returns_user_id;
DROP INDEX IF EXISTS public.idx_returns_status;
DROP INDEX IF EXISTS public.idx_returns_order_id;
DROP INDEX IF EXISTS public.idx_returns_created_at;
DROP INDEX IF EXISTS public.idx_return_items_return_id;
DROP INDEX IF EXISTS public.idx_retry_queue_status;
DROP INDEX IF EXISTS public.idx_retry_queue_reference;
DROP INDEX IF EXISTS public.idx_retry_queue_provider;
DROP INDEX IF EXISTS public.idx_retry_queue_priority;
DROP INDEX IF EXISTS public.idx_retry_queue_next_retry;
DROP INDEX IF EXISTS public.idx_retry_queue_created_at;
DROP INDEX IF EXISTS public.idx_rankings_trending;
DROP INDEX IF EXISTS public.idx_rankings_relevance;
DROP INDEX IF EXISTS public.idx_rankings_popularity;
DROP INDEX IF EXISTS public.idx_rankings_overall;
DROP INDEX IF EXISTS public.idx_query_cache_hits;
...
DROP INDEX IF EXISTS public.idx_products_seller_state;
DROP INDEX IF EXISTS public.idx_products_seller_location;
DROP INDEX IF EXISTS public.idx_products_seller_id;
DROP INDEX IF EXISTS public.idx_products_seller_city;
...
DROP INDEX IF EXISTS public.idx_products_sales;
DROP INDEX IF EXISTS public.idx_products_rating_average;
DROP INDEX IF EXISTS public.idx_products_name_trgm;
DROP INDEX IF EXISTS public.idx_products_has_free_shipping;
DROP INDEX IF EXISTS public.idx_products_filters;
DROP INDEX IF EXISTS public.idx_products_featured;
DROP INDEX IF EXISTS public.idx_products_delivery_days;
DROP INDEX IF EXISTS public.idx_products_condition;
DROP INDEX IF EXISTS public.idx_products_category;
DROP INDEX IF EXISTS public.idx_product_counts_unique;
DROP INDEX IF EXISTS public.idx_popular_searches_term;
DROP INDEX IF EXISTS public.idx_popular_searches_period;
...
DROP INDEX IF EXISTS public.idx_payments_method;
DROP INDEX IF EXISTS public.idx_payment_queue_status;
DROP INDEX IF EXISTS public.idx_payment_queue_payment_id;
...
DROP INDEX IF EXISTS public.idx_order_tracking_status;
DROP INDEX IF EXISTS public.idx_order_tracking_order_id;
DROP INDEX IF EXISTS public.idx_order_tracking_created_at;
DROP INDEX IF EXISTS public.idx_order_status_history_order_id;
DROP INDEX IF EXISTS public.idx_order_items_seller_id;
...
DROP INDEX IF EXISTS public.idx_modality_configs_zone;
DROP INDEX IF EXISTS public.idx_modality_configs_seller;
DROP INDEX IF EXISTS public.idx_modality_configs_modality;
DROP INDEX IF EXISTS public.idx_modalities_priority;
DROP INDEX IF EXISTS public.idx_modalities_active;
DROP INDEX IF EXISTS public.idx_marketing_campaigns_type;
DROP INDEX IF EXISTS public.idx_marketing_campaigns_status;
DROP INDEX IF EXISTS public.idx_marketing_campaigns_start_date;
DROP INDEX IF EXISTS public.idx_maintenance_log_time;
DROP INDEX IF EXISTS public.idx_maintenance_log_task;
DROP INDEX IF EXISTS public.idx_integration_providers_type;
DROP INDEX IF EXISTS public.idx_integration_providers_name;
DROP INDEX IF EXISTS public.idx_integration_providers_active;
DROP INDEX IF EXISTS public.idx_integration_metrics_provider;
DROP INDEX IF EXISTS public.idx_integration_metrics_period;
DROP INDEX IF EXISTS public.idx_integration_metrics_operation;
DROP INDEX IF EXISTS public.idx_integration_logs_reference;
DROP INDEX IF EXISTS public.idx_integration_logs_provider;
DROP INDEX IF EXISTS public.idx_integration_logs_level;
DROP INDEX IF EXISTS public.idx_integration_logs_event_type;
DROP INDEX IF EXISTS public.idx_integration_logs_created_at;
DROP INDEX IF EXISTS public.idx_integration_environments_current;
DROP INDEX IF EXISTS public.idx_gift_lists_user_id;
DROP INDEX IF EXISTS public.idx_gift_lists_type;
DROP INDEX IF EXISTS public.idx_gift_lists_status;
DROP INDEX IF EXISTS public.idx_gift_lists_share_token;
DROP INDEX IF EXISTS public.idx_gift_lists_event_date;
DROP INDEX IF EXISTS public.idx_gift_lists_created_at;
DROP INDEX IF EXISTS public.idx_gift_list_items_product_id;
DROP INDEX IF EXISTS public.idx_gift_list_items_priority;
DROP INDEX IF EXISTS public.idx_gift_list_items_list_id;
DROP INDEX IF EXISTS public.idx_gift_list_items_is_purchased;
DROP INDEX IF EXISTS public.idx_gift_list_items_display_order;
DROP INDEX IF EXISTS public.idx_gift_list_invites_token;
DROP INDEX IF EXISTS public.idx_gift_list_invites_status;
DROP INDEX IF EXISTS public.idx_gift_list_invites_list_id;
DROP INDEX IF EXISTS public.idx_gift_list_invites_email;
DROP INDEX IF EXISTS public.idx_gift_list_analytics_metric;
DROP INDEX IF EXISTS public.idx_gift_list_analytics_list_id;
DROP INDEX IF EXISTS public.idx_gift_list_analytics_date;
DROP INDEX IF EXISTS public.idx_gift_contributions_payment_status;
DROP INDEX IF EXISTS public.idx_gift_contributions_list_id;
DROP INDEX IF EXISTS public.idx_gift_contributions_item_id;
DROP INDEX IF EXISTS public.idx_gift_contributions_created_at;
DROP INDEX IF EXISTS public.idx_gift_contributions_contributor;
DROP INDEX IF EXISTS public.idx_gdpr_requests_user_id;
DROP INDEX IF EXISTS public.idx_gdpr_requests_type;
DROP INDEX IF EXISTS public.idx_gdpr_requests_status;
DROP INDEX IF EXISTS public.idx_gdpr_requests_created_at;
DROP INDEX IF EXISTS public.idx_facet_cache_type;
DROP INDEX IF EXISTS public.idx_facet_cache_expires;
DROP INDEX IF EXISTS public.idx_facet_cache_created;
...
DROP INDEX IF EXISTS public.idx_consent_records_granted;
DROP INDEX IF EXISTS public.idx_consent_records_created_at;
DROP INDEX IF EXISTS public.idx_chat_presence_user_id;
DROP INDEX IF EXISTS public.idx_chat_presence_status;
DROP INDEX IF EXISTS public.idx_chat_presence_last_activity;
...
DROP INDEX IF EXISTS public.idx_chat_message_reads_user_id;
DROP INDEX IF EXISTS public.idx_chat_message_reads_message_id;
DROP INDEX IF EXISTS public.idx_chat_conversations_type;
DROP INDEX IF EXISTS public.idx_chat_conversations_status;
DROP INDEX IF EXISTS public.idx_chat_conversations_seller_id;
DROP INDEX IF EXISTS public.idx_chat_conversations_participants;
DROP INDEX IF EXISTS public.idx_chat_conversations_order_id;
DROP INDEX IF EXISTS public.idx_chat_conversations_last_message;
DROP INDEX IF EXISTS public.idx_category_counts_slug;
DROP INDEX IF EXISTS public.idx_category_counts_id;
...
DROP INDEX IF EXISTS public.idx_campaign_analytics_campaign_metric;
DROP INDEX IF EXISTS public.idx_calculated_options_modality;
DROP INDEX IF EXISTS public.idx_calculated_options_expires;
DROP INDEX IF EXISTS public.idx_calculated_options_base;
DROP INDEX IF EXISTS public.idx_brand_counts_slug;
DROP INDEX IF EXISTS public.idx_brand_counts_id;
DROP INDEX IF EXISTS public.idx_base_rates_zone;
DROP INDEX IF EXISTS public.idx_base_rates_template;
DROP INDEX IF EXISTS public.idx_base_rates_active;
DROP INDEX IF EXISTS public.idx_audit_logs_user_id;
DROP INDEX IF EXISTS public.idx_audit_logs_table_record;
DROP INDEX IF EXISTS public.idx_audit_logs_risk_level;
...
DROP INDEX IF EXISTS public.idx_addresses_is_default;
DROP INDEX IF EXISTS public.idx_ab_tests_status;
DROP INDEX IF EXISTS public.idx_ab_test_variants_test_id;
DROP INDEX IF EXISTS public.idx_ab_test_events_test_variant;
DROP INDEX IF EXISTS public.idx_ab_test_events_event_type;
DROP INDEX IF EXISTS public.idx_ab_test_events_created_at;
DROP INDEX IF EXISTS public.idx_ab_test_assignments_test_user;
DROP INDEX IF EXISTS public.idx_ab_test_assignments_test_session;
...
ALTER TABLE IF EXISTS ONLY public.user_sessions_multi_role DROP CONSTRAINT IF EXISTS user_sessions_multi_role_token_key;
ALTER TABLE IF EXISTS ONLY public.user_sessions_multi_role DROP CONSTRAINT IF EXISTS user_sessions_multi_role_pkey;
ALTER TABLE IF EXISTS ONLY public.product_variants DROP CONSTRAINT IF EXISTS unique_variant_sku;
ALTER TABLE IF EXISTS ONLY public.variant_option_values DROP CONSTRAINT IF EXISTS unique_variant_option_value;
ALTER TABLE IF EXISTS ONLY public.product_options DROP CONSTRAINT IF EXISTS unique_product_option_name;
ALTER TABLE IF EXISTS ONLY public.product_option_values DROP CONSTRAINT IF EXISTS unique_option_value;
ALTER TABLE IF EXISTS ONLY public.tracking_consents DROP CONSTRAINT IF EXISTS tracking_consents_session_id_cookie_category_key;
ALTER TABLE IF EXISTS ONLY public.tracking_consents DROP CONSTRAINT IF EXISTS tracking_consents_pkey;
...
ALTER TABLE IF EXISTS ONLY public.support_categories DROP CONSTRAINT IF EXISTS support_categories_pkey;
ALTER TABLE IF EXISTS ONLY public.store_credits DROP CONSTRAINT IF EXISTS store_credits_pkey;
ALTER TABLE IF EXISTS ONLY public.stock_reservations DROP CONSTRAINT IF EXISTS stock_reservations_pkey;
ALTER TABLE IF EXISTS ONLY public.stock_reservation_items DROP CONSTRAINT IF EXISTS stock_reservation_items_pkey;
...
ALTER TABLE IF EXISTS ONLY public.shipping_quotes DROP CONSTRAINT IF EXISTS shipping_quotes_pkey;
ALTER TABLE IF EXISTS ONLY public.shipping_quotes DROP CONSTRAINT IF EXISTS shipping_quotes_cache_key_key;
ALTER TABLE IF EXISTS ONLY public.shipping_modality_configs DROP CONSTRAINT IF EXISTS shipping_modality_configs_pkey;
ALTER TABLE IF EXISTS ONLY public.shipping_modalities DROP CONSTRAINT IF EXISTS shipping_modalities_pkey;
ALTER TABLE IF EXISTS ONLY public.shipping_carriers DROP CONSTRAINT IF EXISTS shipping_carriers_pkey;
ALTER TABLE IF EXISTS ONLY public.shipping_calculated_options DROP CONSTRAINT IF EXISTS shipping_calculated_options_pkey;
ALTER TABLE IF EXISTS ONLY public.shipping_base_rates DROP CONSTRAINT IF EXISTS shipping_base_rates_pkey;
...
ALTER TABLE IF EXISTS ONLY public.sellers DROP CONSTRAINT IF EXISTS sellers_slug_key;
...
ALTER TABLE IF EXISTS ONLY public.seller_shipping_configs DROP CONSTRAINT IF EXISTS seller_shipping_configs_pkey;
ALTER TABLE IF EXISTS ONLY public.search_suggestions DROP CONSTRAINT IF EXISTS search_suggestions_pkey;
ALTER TABLE IF EXISTS ONLY public.search_index DROP CONSTRAINT IF EXISTS search_index_pkey;
...
ALTER TABLE IF EXISTS ONLY public.return_reasons DROP CONSTRAINT IF EXISTS return_reasons_pkey;
...
ALTER TABLE IF EXISTS ONLY public.product_rankings DROP CONSTRAINT IF EXISTS product_rankings_pkey;
...
ALTER TABLE IF EXISTS ONLY public.popular_searches DROP CONSTRAINT IF EXISTS popular_searches_term_key;
ALTER TABLE IF EXISTS ONLY public.popular_searches DROP CONSTRAINT IF EXISTS popular_searches_pkey;
ALTER TABLE IF EXISTS ONLY public.pending_refreshes DROP CONSTRAINT IF EXISTS pending_refreshes_pkey;
...
ALTER TABLE IF EXISTS ONLY public.payment_queue DROP CONSTRAINT IF EXISTS payment_queue_pkey;
...
ALTER TABLE IF EXISTS ONLY public.notification_templates DROP CONSTRAINT IF EXISTS notification_templates_name_key;
...
ALTER TABLE IF EXISTS ONLY public.integration_retry_queue DROP CONSTRAINT IF EXISTS integration_retry_queue_pkey;
ALTER TABLE IF EXISTS ONLY public.integration_providers DROP CONSTRAINT IF EXISTS integration_providers_pkey;
ALTER TABLE IF EXISTS ONLY public.integration_providers DROP CONSTRAINT IF EXISTS integration_providers_name_key;
ALTER TABLE IF EXISTS ONLY public.integration_provider_environments DROP CONSTRAINT IF EXISTS integration_provider_environments_pkey;
ALTER TABLE IF EXISTS ONLY public.integration_provider_environments DROP CONSTRAINT IF EXISTS integration_provider_environment_provider_id_environment_id_key;
ALTER TABLE IF EXISTS ONLY public.integration_metrics DROP CONSTRAINT IF EXISTS integration_metrics_provider_id_operation_period_start_peri_key;
ALTER TABLE IF EXISTS ONLY public.integration_metrics DROP CONSTRAINT IF EXISTS integration_metrics_pkey;
ALTER TABLE IF EXISTS ONLY public.integration_logs DROP CONSTRAINT IF EXISTS integration_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.integration_environments DROP CONSTRAINT IF EXISTS integration_environments_pkey;
ALTER TABLE IF EXISTS ONLY public.integration_environments DROP CONSTRAINT IF EXISTS integration_environments_name_key;
ALTER TABLE IF EXISTS ONLY public.gift_lists DROP CONSTRAINT IF EXISTS gift_lists_share_token_key;
ALTER TABLE IF EXISTS ONLY public.gift_lists DROP CONSTRAINT IF EXISTS gift_lists_pkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_templates DROP CONSTRAINT IF EXISTS gift_list_templates_pkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_items DROP CONSTRAINT IF EXISTS gift_list_items_pkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_invites DROP CONSTRAINT IF EXISTS gift_list_invites_pkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_invites DROP CONSTRAINT IF EXISTS gift_list_invites_invitation_token_key;
ALTER TABLE IF EXISTS ONLY public.gift_list_favorites DROP CONSTRAINT IF EXISTS gift_list_favorites_user_id_list_id_key;
ALTER TABLE IF EXISTS ONLY public.gift_list_favorites DROP CONSTRAINT IF EXISTS gift_list_favorites_pkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_comments DROP CONSTRAINT IF EXISTS gift_list_comments_pkey;
ALTER TABLE IF EXISTS ONLY public.gift_list_analytics DROP CONSTRAINT IF EXISTS gift_list_analytics_pkey;
ALTER TABLE IF EXISTS ONLY public.gift_contributions DROP CONSTRAINT IF EXISTS gift_contributions_pkey;
ALTER TABLE IF EXISTS ONLY public.gdpr_requests DROP CONSTRAINT IF EXISTS gdpr_requests_pkey;
...
ALTER TABLE IF EXISTS ONLY public.facet_cache DROP CONSTRAINT IF EXISTS facet_cache_pkey;
ALTER TABLE IF EXISTS ONLY public.email_queue DROP CONSTRAINT IF EXISTS email_queue_pkey;
ALTER TABLE IF EXISTS ONLY public.data_processing_activities DROP CONSTRAINT IF EXISTS data_processing_activities_pkey;
...
ALTER TABLE IF EXISTS ONLY public.coupon_products DROP CONSTRAINT IF EXISTS coupon_products_coupon_id_product_id_key;
ALTER TABLE IF EXISTS ONLY public.coupon_conditions DROP CONSTRAINT IF EXISTS coupon_conditions_pkey;
ALTER TABLE IF EXISTS ONLY public.coupon_categories DROP CONSTRAINT IF EXISTS coupon_categories_pkey;
ALTER TABLE IF EXISTS ONLY public.coupon_categories DROP CONSTRAINT IF EXISTS coupon_categories_coupon_id_category_id_key;
ALTER TABLE IF EXISTS ONLY public.consent_records DROP CONSTRAINT IF EXISTS consent_records_pkey;
ALTER TABLE IF EXISTS ONLY public.chat_settings DROP CONSTRAINT IF EXISTS chat_settings_user_id_key;
...
ALTER TABLE IF EXISTS ONLY public.chat_message_reads DROP CONSTRAINT IF EXISTS chat_message_reads_message_id_user_id_key;
...
ALTER TABLE IF EXISTS ONLY public.campaign_analytics DROP CONSTRAINT IF EXISTS campaign_analytics_pkey;
...
ALTER TABLE IF EXISTS ONLY public.ab_test_events DROP CONSTRAINT IF EXISTS ab_test_events_pkey;
ALTER TABLE IF EXISTS ONLY public.ab_test_assignments DROP CONSTRAINT IF EXISTS ab_test_assignments_test_id_user_id_key;
ALTER TABLE IF EXISTS ONLY public.ab_test_assignments DROP CONSTRAINT IF EXISTS ab_test_assignments_test_id_session_id_key;
...
DROP TABLE IF EXISTS public.users_backup_roles;
DROP TABLE IF EXISTS public.users;
DROP TABLE IF EXISTS public.user_sessions_multi_role;
DROP TABLE IF EXISTS public.tracking_consents;
DROP TABLE IF EXISTS public.system_settings;
DROP TABLE IF EXISTS public.support_tickets;
DROP TABLE IF EXISTS public.support_messages;
DROP TABLE IF EXISTS public.support_categories;
DROP TABLE IF EXISTS public.store_credits;
DROP TABLE IF EXISTS public.stock_reservations;
DROP TABLE IF EXISTS public.stock_reservation_items;
...
DROP TABLE IF EXISTS public.shipping_modality_configs;
DROP TABLE IF EXISTS public.shipping_modalities;
DROP TABLE IF EXISTS public.shipping_carriers;
DROP TABLE IF EXISTS public.shipping_calculated_options;
DROP TABLE IF EXISTS public.shipping_base_rates;
DROP TABLE IF EXISTS public.sessions;
DROP TABLE IF EXISTS public.sellers;
DROP TABLE IF EXISTS public.seller_shipping_configs;
DROP TABLE IF EXISTS public.search_suggestions;
DROP TABLE IF EXISTS public.search_history;
DROP TABLE IF EXISTS public.reviews;
DROP TABLE IF EXISTS public.returns;
DROP TABLE IF EXISTS public.return_reasons;
...
DROP MATERIALIZED VIEW IF EXISTS public.product_counts;
DROP TABLE IF EXISTS public.pending_refreshes;
DROP TABLE IF EXISTS public.payments;
DROP TABLE IF EXISTS public.payment_transactions;
DROP TABLE IF EXISTS public.payment_queue;
...
DROP VIEW IF EXISTS public.integration_providers_status;
DROP TABLE IF EXISTS public.integration_retry_queue;
DROP TABLE IF EXISTS public.integration_providers;
DROP TABLE IF EXISTS public.integration_provider_environments;
DROP TABLE IF EXISTS public.integration_metrics;
DROP VIEW IF EXISTS public.integration_logs_summary;
DROP TABLE IF EXISTS public.integration_logs;
DROP TABLE IF EXISTS public.integration_environments;
DROP TABLE IF EXISTS public.gift_lists;
DROP TABLE IF EXISTS public.gift_list_templates;
DROP TABLE IF EXISTS public.gift_list_items;
DROP TABLE IF EXISTS public.gift_list_invites;
DROP TABLE IF EXISTS public.gift_list_favorites;
DROP TABLE IF EXISTS public.gift_list_comments;
DROP TABLE IF EXISTS public.gift_list_analytics;
DROP TABLE IF EXISTS public.gift_contributions;
DROP TABLE IF EXISTS public.gdpr_requests;
DROP TABLE IF EXISTS public.faqs;
DROP TABLE IF EXISTS public.faq;
DROP TABLE IF EXISTS public.facet_cache;
DROP TABLE IF EXISTS public.email_queue;
DROP TABLE IF EXISTS public.data_processing_activities;
DROP TABLE IF EXISTS public.coupons;
DROP TABLE IF EXISTS public.coupon_usage;
DROP TABLE IF EXISTS public.coupon_products;
DROP TABLE IF EXISTS public.coupon_conditions;
...
DROP MATERIALIZED VIEW IF EXISTS public.category_product_counts;
DROP TABLE IF EXISTS public.categories;
DROP TABLE IF EXISTS public.carts;
DROP TABLE IF EXISTS public.cart_items;
DROP TABLE IF EXISTS public.campaign_recipients;
DROP TABLE IF EXISTS public.campaign_analytics;
DROP MATERIALIZED VIEW IF EXISTS public.brand_product_counts;
...
DROP TABLE IF EXISTS public.ab_test_events;
DROP TABLE IF EXISTS public.ab_test_assignments;
DROP FUNCTION IF EXISTS public.user_has_role(user_roles text[], check_role text);
DROP FUNCTION IF EXISTS public.update_updated_at_column();
DROP FUNCTION IF EXISTS public.update_search_index();
DROP FUNCTION IF EXISTS public.update_popular_searches();
DROP FUNCTION IF EXISTS public.update_gift_list_amounts();
DROP FUNCTION IF EXISTS public.update_all_rankings();
DROP FUNCTION IF EXISTS public.trigger_update_search_index();
DROP FUNCTION IF EXISTS public.trigger_update_counts();
DROP FUNCTION IF EXISTS public.refresh_all_materialized_views();
DROP FUNCTION IF EXISTS public.record_gift_list_metric(p_list_id uuid, p_metric_name character varying, p_metric_value numeric, p_source character varying, p_metadata jsonb);
DROP FUNCTION IF EXISTS public.process_webhook_queue();
DROP FUNCTION IF EXISTS public.process_pending_refreshes();
DROP FUNCTION IF EXISTS public.process_integration_retry_queue();
DROP FUNCTION IF EXISTS public.optimize_tables();
DROP FUNCTION IF EXISTS public.monitor_search_performance();
DROP FUNCTION IF EXISTS public.log_gift_list_activity(p_list_id uuid, p_user_id uuid, p_action character varying, p_details jsonb);
DROP FUNCTION IF EXISTS public.get_available_apps(user_roles text[]);
DROP FUNCTION IF EXISTS public.generate_share_token_trigger();
DROP FUNCTION IF EXISTS public.generate_share_token();
DROP FUNCTION IF EXISTS public.generate_calculated_options(p_base_rate_id text);
DROP FUNCTION IF EXISTS public.find_shipping_zone_advanced(p_postal_code character varying, p_carrier_id text);
DROP FUNCTION IF EXISTS public.find_shipping_zone(p_postal_code character varying, p_carrier_id text);
DROP FUNCTION IF EXISTS public.create_audit_log(p_user_id uuid, p_table_name character varying, p_record_id character varying, p_action character varying, p_old_values jsonb, p_new_values jsonb, p_ip_address inet, p_session_id character varying, p_reason text);
DROP FUNCTION IF EXISTS public.cleanup_expired_caches();
DROP FUNCTION IF EXISTS public.calculate_product_rankings();
DROP FUNCTION IF EXISTS public.calculate_integration_metrics(p_provider_id uuid, p_period_type character varying);
DROP FUNCTION IF EXISTS public.assign_user_to_ab_test(p_test_id uuid, p_user_id uuid, p_session_id character varying);

-- =====================================================
-- SINCRONIZAÇÃO COMPLETA: CAMPOS DE PRODUTOS V2
-- =====================================================
...
-- 7. ESTRUTURA PADRÃO PARA CAMPOS JSONB
-- Garantir que todos produtos tenham estrutura mínima nos campos JSONB
UPDATE products 
...
-- 8. EXEMPLOS DE USO DOS CAMPOS JSONB
-- attributes: Para filtros dinâmicos (cores, tamanhos, etc)
-- Exemplo: {"cor": ["Azul", "Verde"], "tamanho": ["P", "M", "G"], "memoria": ["8GB", "16GB"]}

-- specifications: Para especificações técnicas detalhadas
-- Exemplo: {"peso": "1.5kg", "dimensoes": "30x20x10cm", "material": "Plástico ABS", "voltagem": "110V/220V"}

-- custom_fields será armazenado em specifications
-- download_files será gerenciado pela tabela product_downloads
...
WHERE 
    ...
    AND column_name IN (
        ...
        'internal_notes', 'attributes', 'specifications'
    )

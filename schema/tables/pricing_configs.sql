-- Tabela de configurações dinâmicas de pricing
-- Permite alteração de regras sem deploy, com override por categoria/seller
...
CREATE TABLE IF NOT EXISTS pricing_configs (
    ...
    -- Scoping para aplicar regras específicas
